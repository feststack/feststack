...
export namespace Prisma {
  ...
  */
  ...
  export interface ConfigDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * const configWithConfigIdOnly = await prisma.config.findMany({ select: { configId: true } })
     * 
     */
  ...
  interface ConfigFieldRefs {
    readonly configId: FieldRef<"Config", 'Int'>
  ...
  export type ConfigWhereInput = {
    ...
    configId?: IntFilter<"Config"> | number
  ...
  export type ConfigScalarWhereWithAggregatesInput = {
    ...
    configId?: IntWithAggregatesFilter<"Config"> | number
