  ...
  useEffect(() => {
    ...
    async function fetchUser() {
      try {
        ...
        if (!res.ok) {
          setLoading(false)  // <- Ajoute ça aussi
          router.push('/')
          return
        }
        ...
        setLoading(false)  // <- Ajoute aussi ici
        router.push('/')
      } finally {
        setLoading(false)  // et ici, même si tu le fais dans try et catch, ça peut rester pour sûreté
      }
    }
